...
namespace CoreWaggles.Commands
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\javie\Desktop\1_Perez_Javier\pokeman\sentiment\yelp_labelled.txt";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"col0",outputColumnName:@"col0")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.LbfgsMaximumEntropy(new LbfgsMaximumEntropyMulticlassTrainer.Options(){L1Regularization=0.03862434F,L2Regularization=0.37863705F,LabelColumnName=@"col1",FeatureColumnName=@"Features"}))      
