...
public class aliases : ModuleBase<SocketCommandContext>
{
    ...
    {
        var builder = new EmbedBuilder();
        builder.AddInlineField("Author", "Hoovier#4192");
        builder.AddInlineField("Library", "[Discord.net](https://github.com/discord-net/Discord.Net)");
        builder.AddInlineField("Owner ID", "223651215337193472");
        builder.AddInlineField("Contributor", "LazyReader (MaxR#4813)");
        builder.AddInlineField("Website", "https://Waggles.org/");
